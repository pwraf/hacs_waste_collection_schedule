...
You can make a test API call with http://api.cross-7.de/public/calendar/399/events/ics?SecondCategoryIds=68329 and download the ICS file, open in an editor and read out the location. Following is a list of SecondCategoryIds and their locations :
68320 Schwäb. Hall 4
